...
class Ui_DatabasesPage(object):
    def setupUi(self, DatabasesPage):
        ...
        self.database_content_layout.addLayout(self.horizontalLayout, 1, 2, 1, 1)
        ...
        self.database_content_layout.addWidget(self.mariadb_config_pushButton, 2, 4, 1, 1)
        ...
        self.database_content_layout.addLayout(self.horizontalLayout_2, 1, 3, 1, 1)
        ...
        self.database_content_layout.addLayout(self.horizontalLayout_7, 4, 2, 1, 1)
        ...
        self.database_content_layout.addLayout(self.horizontalLayout_5, 3, 2, 1, 1)

        self.mariadb_port_lineEdit = QLineEdit(DatabasesPage)
        self.mariadb_port_lineEdit.setObjectName(u"mariadb_port_lineEdit")

        self.database_content_layout.addWidget(self.mariadb_port_lineEdit, 2, 1, 1, 1)
        ...
        self.database_content_layout.addWidget(self.mysql_config_pushButton, 1, 4, 1, 1)

        self.label_3 = QLabel(DatabasesPage)
        self.label_3.setObjectName(u"label_3")
        self.label_3.setStyleSheet(u"font: 14pt \"Segoe UI\";")

        self.database_content_layout.addWidget(self.label_3, 0, 1, 1, 1, Qt.AlignmentFlag.AlignHCenter)
...
"align-text: center")
        ...
        self.database_content_layout.addWidget(self.postgresql_config_pushButton, 3, 4, 1, 1)

        self.mysql_port_lineEdit = QLineEdit(DatabasesPage)
        self.mysql_port_lineEdit.setObjectName(u"mysql_port_lineEdit")

        self.database_content_layout.addWidget(self.mysql_port_lineEdit, 1, 1, 1, 1)
        ...
        self.database_content_layout.addWidget(self.mongodb_config_pushButton, 4, 4, 1, 1)
        ...
        self.database_content_layout.addWidget(self.mongodb_port_lineEdit, 4, 1, 1, 1)
        ...
        self.database_content_layout.addWidget(self.label_4, 0, 2, 1, 1, Qt.AlignmentFlag.AlignHCenter)
        ...
        self.database_content_layout.addLayout(self.horizontalLayout_3, 2, 2, 1, 1)
        ...
        self.database_content_layout.addLayout(self.horizontalLayout_4, 2, 3, 1, 1)

        self.label_5 = QLabel(DatabasesPage)
        self.label_5.setObjectName(u"label_5")
        self.label_5.setStyleSheet(u"font: 14pt \"Segoe UI\";")

        self.database_content_layout.addWidget(self.label_5, 0, 3, 1, 1, Qt.AlignmentFlag.AlignHCenter)
        ...
        self.database_content_layout.addWidget(self.postgresql_port_lineEdit, 3, 1, 1, 1)
        ...
        self.database_content_layout.addLayout(self.horizontalLayout_6, 3, 3, 1, 1)
        ...
        self.database_content_layout.addLayout(self.horizontalLayout_8, 4, 3, 1, 1)

        self.database_content_layout.setColumnStretch(2, 1)
        self.database_content_layout.setColumnStretch(3, 1)
